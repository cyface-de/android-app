...
import de.cyface.app.r4r.ui.LoginActivity;
...
public class Application extends android.app.Application /* MultiDexApplication */ {
    ...
    private final ErrorHandler.ErrorListener errorListener = (errorCode, errorMessage) -> {
        ...
        Toast.makeText(this, String.format("%s - %s", errorMessage, appName), Toast.LENGTH_LONG).show();
        ...
        final var isReportingEnabled = preferences.getBoolean(ACCEPTED_REPORTING_KEY, false);
