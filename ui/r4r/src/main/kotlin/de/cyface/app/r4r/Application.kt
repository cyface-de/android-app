...
class Application : Application() {
    ...
    private val errorListener =
        ErrorHandler.ErrorListener { errorCode: ErrorCode, errorMessage: String ->
            ...
            Toast.makeText(this, String.format("%s - %s", errorMessage, appName), Toast.LENGTH_LONG)
                .show()
    ...
    companion object {
        /**
         * @return the [ErrorHandler] required to register an [ErrorHandler.ErrorListener]
         */
        /**
