 ...
 * @version 4.0.3
 * @since 1.0.0
 * @property context The [Context] required to access the [AccountManager].
 */
// TODO Replace AsyncTask
abstract class AuthTokenRequest protected constructor(private val context: WeakReference<Context>) :
